...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px;">
  <img src="./screenshots/install.png" alt="Login Language" style="width: 100%; height: auto;">
</div>

## Login

<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px;">
  <img src="./screenshots/login_language.png" alt="Login Language" style="width: 100%; height: auto;">
  <img src="./screenshots/login_login.png" alt="Login" style="width: 100%; height: auto;">
  <img src="./screenshots/login_recover.png" alt="Recover" style="width: 100%; height: auto;">
  <img src="./screenshots/login_register.png" alt="Register" style="width: 100%; height: auto;">
</div>
