<?php
	...
	*/ if(!is_array(@$object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
	$object["mysql"]->multi_query("CREATE TABLE IF NOT EXISTS `"._HIVE_SITE_PREFIX_."book_item` (
	  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique Item ID',
	  `fk_book` int(11) NULL COMMENT 'Book Relation',      
	  `book_barcode` text NULL COMMENT 'Book Stock Barcode',      
