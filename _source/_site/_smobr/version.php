<?php
	...
	*/ if(!is_array(@$object)) { @http_response_code(404); Header("Location: ../"); exit(); }
	...
	##############################
		...
		$x["name"] 			= "Online Book Renting";
		
		// Module Description 
		// Description for the Module with informations for the store or internal sites.
		$x["description"] = "The Online-Book-Renting (obr) system is a comprehensive platform that manages book rentals, tracks return deadlines, allows users to donate books, and supports multi-language preferences.";
	...
	##############################
		...
		$x["documentation"] = "https://bugfishtm.github.io/Online-Book-Renting/";	
	
		// Module Github Website
		$x["github"] 		= "https://github.com/bugfishtm/Online-Book-Renting";	
